...
import com.example.javasem.data.database.WeatherCityRepository;
import com.example.javasem.data.model.*;
import com.example.javasem.exceptions.ErrorReadingProperties;
...
public class WeatherController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        String path = "src/main/resources/com/example/javasem/api.properties";
    ...
    @FXML
    private void handleGetWeather() throws IOException {
    ...
    private void fetchWeatherData(String city) {
        ...
        weatherIcon.setImage(new Image(weatherCity.getWeather().get(0).getIcon()));
        cityLabel.setText(city.substring(0, 1).toUpperCase() + city.substring(1).toLowerCase());
        precipitationLabel.setText(weatherCity.getWeather().get(0).getDescription());
